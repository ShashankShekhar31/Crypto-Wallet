...
import type { MnemonicService, MnemonicStrength, SecretBytes } from "./wallet-crypto-types.js";
...
export class Bip39MnemonicService implements MnemonicService {
  ...
  async toSeed(mnemonic: string, passphrase?: string): Promise<SecretBytes> {
