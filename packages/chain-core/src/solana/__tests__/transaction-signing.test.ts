...
describe(
  "Solana transaction signing integration",
  () => {
    it(
    ...
    it(
      "creates a signed transaction from the compiled message",
      () => {
        const message =
          compileSolanaTransactionMessage(
            createTransaction(),
    ...
    it(
      "preserves the exact serialized message",
      () => {
        const message =
          compileSolanaTransactionMessage(
            createTransaction(),
    ...
    it(
      "places the signature before the message",
      () => {
        const message =
          compileSolanaTransactionMessage(
            createTransaction(),
    ...
    it(
      "produces deterministic transaction bytes",
      () => {
        const firstMessage =
          compileSolanaTransactionMessage(
            createTransaction(),
