...
describe(
  ...
  () => {
    ...
    it(
      "serializes the signature before the message",
      () => {
        const result =
          createSolanaSignedTransaction(
            createMessage(),
    ...
    it(
      "places the serialized message after signatures",
      () => {
        const result =
          createSolanaSignedTransaction(
            createMessage(),
    ...
    it(
      "rejects a signature count mismatch",
      () => {
        expect(() =>
          createSolanaSignedTransaction(
            createMessage(),
    ...
    it(
      "returns immutable transaction structure",
      () => {
        const result =
          createSolanaSignedTransaction(
            createMessage(),
    ...
    it(
      "does not mutate the input signature",
      () => {
        const signature =
          createSignature(9);
